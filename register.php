      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
              ...
              <div>
                <input style="border:1px solid black; border-radius: 5px; width: 80%; height: 45px; padding: 15px; font-size: 18px;" type="date" id="dob" name="dob" placeholder="Date of Birth *" min="1985-01-01" max="2000-01-01" required="">
              </div>
