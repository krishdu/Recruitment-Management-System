...
<html lang="en">
  ...
  <div style="background-color: #053a5a; height: 80px;">
    <p style="font-size: 34px; color: white; text-align: center; line-height: 75px;">Candidate Login</p>
  </div>
        ...
        <div class="row" align="center">
            <form method="post" action="checklogin.php">
              ...
              <tr>
                <td></td>
                <td></td>
                <td><a href="forgot-password.php" style="font-size: 22px; color: red;">Forgot Password?</a></td>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
              </tr>
